...
<table id="tracked-nations"></table>`;
    ...
    const clearButton = document.querySelector('#clear-tracked-nations');
    void applyReliantButtonKeyDisplays([
        { selector: '#clear-tracked-nations', keySetting: 'dossierkey', defaultKey: 'M' },
    ]);
    ...
    const importButton = document.querySelector('#import-nations');
    const importInput = document.querySelector('#import-nations-input');
