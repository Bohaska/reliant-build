 ...
 */
function disableAllAjaxButtons() {
 ...
 */
async function fetchWithRateLimit(url, options = {}, caller = undefined) {
 ...
 */
async function executeRateLimitedFetch(url, options = {}) {
